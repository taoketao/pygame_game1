...
class Player(Agent):
    ...
    def __init__(ego, gm):
        ...
        ego._belt = Belt(gm, ego, sp_init='basic player')
        ego._logic = Logic(gm, ego, ego._belt) # To change belt, tell the Logic.
...
#        ego.set_plyr_img(DVEC, 'init-shift')
    ...
    # More or less:
    def message_me(ego, message): ego._logic.message_me(message)
