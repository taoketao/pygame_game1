...
#            print 'received message:',Msg
            {   'catching':         mh.MSG_catching,
                ...
                'direct damage':    mh.MSG_direct_damage,
                'kill':             mh.MSG_sigkill,
            }[Msg['msg']](**Msg)
...
#        print "a message",msg,"has been received and identified."
        custom_args = {'msg':msg}
        if msg=='kill': pass
        if msg in ['catching', 'direct damage']: # apply catch 'damage'
...
#            print 'Args to be passed:', custom_args
...
#        print "a message",msg,'/',args,"is being delivered."
        ...
        if msg=='kill' and args['recipient']=='me':
        ...
        elif msg=='direct damage':
            ents = [who[0] for who in mh.gm.query_tile_for_team(\
                    args['recipient']['pkmn_at_tile'], \
                    ('not_my_team', mh.logic.agent.team))] 
            for e_id in ents:
                if not mh.gm.entities[e_id].isMasterAgent: continue
                mh.gm.entities[e_id].receive_message(msg, **args)
